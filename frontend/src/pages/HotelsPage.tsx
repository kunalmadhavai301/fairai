            ...
            <div key={hotel.id} className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4 hover:border-blue-400 transition-all relative">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs">
                ...
                <a
                  ...
                  className="bg-indigo-600 hover:bg-indigo-700 text-white font-black px-4 py-2.5 rounded-xl transition-all flex items-center gap-2 shadow-xs hover:scale-[1.02] active:scale-95"
                  title="Click to call hotel directly on phone dialer"
                >
